...
- [ ] P3-2: 实现故事续写 prompt 模板 (含上下文、人物、风格控制)
- [ ] P3-3: 实现分叉生成逻辑 (基于关键转折点生成多条分支)
- [ ] P3-4: 实现 API Route: POST /api/stories/[id]/continue (续写)
- [ ] P3-5: 实现 API Route: POST /api/stories/[id]/branch (分叉)
- [ ] P3-6: 实现流式响应 (SSE) 支持打字机效果

### Phase 4: 前端页面
- [ ] P4-1: 首页 - 故事列表/选择页
- [ ] P4-2: 故事阅读页 - 树状故事线展示
- [ ] P4-3: 分叉选择页 - 关键节点交互
- [ ] P4-4: 故事创建页 - 选择历史故事/自定义
- [ ] P4-5: 流式文本展示组件 (打字机效果)
...
### Phase 6: 图片生成预留
- [ ] P6-1: 设计图片数据模型 (StorySegment 关联图片)
- [ ] P6-2: 预留 AI 图片生成 API 接口
- [ ] P6-3: 前端图片展示位置预留
